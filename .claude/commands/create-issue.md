...
Once the issue is drafted, **always create it on GitHub** using `gh issue create` on the `dane805-dev/CourseHubv2` repo. Return the issue URL to the user so they (and colleagues) can find it.
